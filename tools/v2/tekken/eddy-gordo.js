...
let npc;
if (getParameterByName('age') === 'tekken8')
    npc = EddyTekken8();
else if (getParameterByName('age') === 'tekken4')
    npc = EddyTekken4();
else
    npc = EddyTekken3();
