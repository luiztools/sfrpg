...
function QuanChiMKX() {
    ...
    const personagem = {
        ...
        NovasTecnicas: tecnicas,
        Armas: armas,
        ManobrasEspeciais: "Jump, Kippup, Foot Sweep, Slide Kick, Power Uppercut, Double-Hit Punch, Suplex, Air Suplex, Wounded Knee, Levitation, Ghost Form, Leech,  Fireball, Improved Fireball, Cobra Charm, Regeneration, Chi Kun Healing, Weapon Sweep, Telekinesis, Flying Heel Stomp, Acid Breath, Throw, Flying Fireball, Yoga Teleport, Chi Push, Portal Attack",
        Combos: "Double-Hit Punch - Double-Hit Punch - Improved Fireball (Dizzy); Double-Hit Punch - Double-Hit Punch - Roundhouse (Dizzy); Jumping Short - Foot Sweep - Slide Kick (Dizzy); Jab – Strong – Fireball (Dizzy); Jab – Strong – Roundhouse (Dizzy); Jumping Short – Foot Sweep – Slide Kick (Dizzy)",
        Gloria: 7,
        Honra: 0,
        Chi: 10,
        ForcaVontade: 10,
